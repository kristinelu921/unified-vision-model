...
from .benchmark_dataset_configs import KITTI_CFG, resolve_name_mode
...
class KITTIDataset(BaseDataset):
    def __init__(
        ...
        **kwargs,
        ...
        cfg = {**KITTI_CFG, **kwargs}
        self.kitti_bm_crop = cfg.pop("kitti_bm_crop")
        self.valid_mask_crop = cfg.pop("valid_mask_crop")
